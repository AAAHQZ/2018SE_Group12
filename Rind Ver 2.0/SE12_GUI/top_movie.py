...
class TopMovie(object):
    def setupUi(self, dialog):
        ...
        self.label_picture.setStyleSheet("image: url(:/new/back_cloud.jpg);")
        ...
        self.label_result.setGeometry(QtCore.QRect(20, 155, 742, 530))
    ...
    def retranslateUi(self, dialog):
        ...
        dialog.setWindowTitle(_translate("dialog", "TOP电影"))
    ...
    def cut_image(self, dialog):
        ...
        self.label_result.render(painter)
        img.save('./SE12_Cache/WordCloud.png')
        painter.end()
    ...
    def put_into_report(self,dialog):
        try:
            ...
            doc = Document('report.docx')
            #插入图片
            images = './SE12_Cache/WordCloud.png'    # 要插入的图片
            doc.add_paragraph('\n')   # 添加文字
            ...
            self.cut_image(dialog)
            images = './SE12_Cache/WordCloud.png'
            doc.add_paragraph('\n')
